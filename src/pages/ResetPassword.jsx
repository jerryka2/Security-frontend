      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-lime-50 to-emerald-50 flex items-center justify-center p-4 sm:p-6">
        <div className="relative bg-white/95 backdrop-blur-md rounded-3xl shadow-[0_4px_16px_rgba(34,197,94,0.1)] max-w-lg w-full p-8 sm:p-10">
          ...
          <div className="text-center space-y-4">
            ...
            <h2 className="text-4xl font-semibold text-green-700 tracking-tight">Invalid Reset Link</h2>
            ...
            <div className="space-y-4">
              <Link
                to="/forgot-password"
                className="block w-full py-3.5 bg-green-600 text-white rounded-xl font-semibold text-lg hover:bg-lime-500 transition-all duration-300 shadow-[0_4px_12px_rgba(34,197,94,0.2)] hover:shadow-[0_6px_16px_rgba(34,197,94,0.3)] text-center"
              >
